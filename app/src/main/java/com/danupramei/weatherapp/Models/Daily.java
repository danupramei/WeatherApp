...
public class Daily {
    ...
    @Expose
    private List<Daily> weather = null;
    ...
    public Daily getTemp() {
        return temp;
    }

    public void setTemp(Daily temp) {
        this.temp = temp;
    }
    ...
    public List<Daily> getWeather() {
        return weather;
    }

    public void setWeather(List<Daily> weather) {
